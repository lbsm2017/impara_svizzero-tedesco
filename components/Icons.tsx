...
export const StarIcon = ({ className, filled = false }: { className?: string, filled?: boolean }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2">
...
export const FruitIcon = ({ className }: { className?: string }) => (
  <span className={className} role="img" aria-label="fruit">🍎</span>
);
...
export const NeedsIcon = ({ className }: { className?: string }) => (
  <span className={className} role="img" aria-label="needs">❤️</span>
);
